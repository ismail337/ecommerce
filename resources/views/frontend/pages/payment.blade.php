                ...
                <div class="row">
                        ...
                        <div class="wsus__payment_menu" id="sticky_sidebar">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                ...
                                <button class="nav-link common_btn" id="v-pills-home-tab" data-bs-toggle="pill"
                                    ...
                                    aria-controls="v-pills-paypal" aria-selected="true">Stripe</button>
                    ...
                    <div class="col-xl-5 col-lg-5">
                        <div class="tab-content" id="v-pills-tabContent" id="sticky_sidebar">
                            ...
                            <div class="tab-pane
                                                fade" id="v-pills-stripe"
                                role="tabpanel" aria-labelledby="v-pills-home-tab">
                                <div class="row">
                                    <div class="col-xl-12 m-auto">
                                        <div class="wsus__payment_area">
                                            <a href="{{ route('user.paypal.payment') }}"
                                                class="nav-link common_btn text-center" href="">Pay
                                                with Stripe</a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="wsus__pay_booking_summary" id="sticky_sidebar2">
                            <h5>Order Summary</h5>
                            <p>subtotal: <span>{{ $generalSetting->currency_icon }} {{ getCartTotal() }}</span>
                            </p>
                            <p>shipping fee(+): <span>{{ $generalSetting->currency_icon }}
                                    {{ getShippingFee() }}</span></p>
                            <p>coupon(-) :
                                <span>{{ $generalSetting->currency_icon }}{{ getCartDiscount() }}</span>
                            </p>
                            <h6>total <span>{{ $generalSetting->currency_icon }}
                                    {{ getFinalPayableAmount() }}</span></h6>
                        </div>
                    </div>
                </div>
            </div>
