<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li
                class="dropdown {{ setActive(['admin.brand.*', 'admin.product.*', 'admin.seller-pending-product.*', 'admin.seller-product.*', 'admin.product-variant-item.*']) }}">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i>
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ setActive(['admin.seller-product.*']) }}"><a class="nav-link"
                            href="{{ route('admin.seller-product.index') }}">Seller Product</a></li>
